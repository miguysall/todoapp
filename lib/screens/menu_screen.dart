...
class MenuScreen extends StatefulWidget {
  const MenuScreen(
      ...
      required Null Function() onMenuClose})
      : super(key: key);
  @override
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        border: Border.all(
                            color: Colors.white.withOpacity(.2), width: 1.5),
                ...
                Container(
                  ...
                  height: 95,
                  decoration: BoxDecoration(
                      color: Color(0xffd103fc), shape: BoxShape.circle),
                ),
                ...
                MenuItem(
                    ...
                    menuItemIcon: Icons.bookmark_border_outlined),
                MenuItem(
                    menuItemText: "Categories",
                    menuItemIcon: Icons.grid_view_outlined),
                MenuItem(
                    menuItemText: "Analytics",
                    menuItemIcon: Icons.pie_chart_outline_outlined),
                Expanded(
                    child: Column(
                        mainAxisAlignment: MainAxisAlignment.end,
                        children: [
